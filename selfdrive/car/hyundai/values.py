...
FEATURES = {
  ...
  "allow_high_steer": set([CAR.KONA, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.IONIQ_EV_2020]),

  "use_bsm": set([CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KONA, CAR.KIA_NIRO_EV, CAR.IONIQ_EV_2020]),
}
